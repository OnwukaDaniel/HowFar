                    ...
                    timeRef.get().addOnSuccessListener {
                        if (it.exists()) {
                            ...
                            myRef.get().addOnSuccessListener { my ->
                                ...
                                val myTemp = ParticipantTempData(uid = myProfile.uid, tempName = myProfile.name, tempImage = myProfile.image,
                                ...
                                receiverRef.get().addOnSuccessListener { receiver ->
                                    ...
                                    val receiverTemp = ParticipantTempData(uid = otherProfile.uid, tempName = otherProfile.name, tempImage = otherProfile.image,
                                    ...
                                    receiverGuestRef.setValue(chatData)
                                }
                            }
                        }
                    }
