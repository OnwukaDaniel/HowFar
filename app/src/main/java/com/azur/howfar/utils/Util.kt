...
object Util {
    ...
    private fun Context.showProgressBar(view: View): Pair<android.app.AlertDialog?, ProgressBar> {
        val progressLayout = LayoutInflater.from(this).inflate(R.layout.fragment_dialog_progress, null, false)
