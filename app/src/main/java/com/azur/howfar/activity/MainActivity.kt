...
class MainActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvLiveRoot.setOnClickListener(this)
        binding.tvVideo.setOnClickListener(this)
        binding.tvOnetoOne.setOnClickListener(this)
    ...
    private fun defaultHome() {
        supportFragmentManager.beginTransaction().replace(R.id.home_root_frags, LiveFragmentMain()).commit()
    ...
    private fun initBottomBar() {
        ...
        binding.lytDiscover.setOnClickListener { setUpFragment(FeedFragmentMain(), binding.animDiscover, "animDiscover") }
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.tvLiveRoot -> {
                ...
                supportFragmentManager.beginTransaction().addToBackStack(null).replace(R.id.home_root_frags, LiveFragmentMain()).commit()
                resetTabs()
                setTab(binding.line1, binding.tvLive)
            }
            R.id.tvVideo -> startActivity(Intent(this, VideoListActivity::class.java))
            R.id.tvOnetoOne -> startActivity(Intent(this, RandomMatchActivity::class.java))
            R.id.imgBall -> {
