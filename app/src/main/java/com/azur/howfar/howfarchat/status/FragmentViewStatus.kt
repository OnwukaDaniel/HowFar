...
class FragmentViews : Fragment(), View.OnClickListener, View.OnLongClickListener, View.OnTouchListener {
    ...
    private fun sendNewMsg(message: String = "") {
        ...
        val myProfileRef = FirebaseDatabase.getInstance().reference.child(USER_DETAILS).child(user!!.uid)
        val otherUserRef = FirebaseDatabase.getInstance().reference.child(USER_DETAILS).child(statusUpdateData.senderUid)
                                    ...
                                    chattingRef.child(myChat.uniqueQuerableTime).setValue(myChat).addOnSuccessListener {
                                        ...
                                        blockedRef.get().addOnSuccessListener { blocked ->
                                            ...
                                            if (blocked.exists()) {
                                                ...
                                                if (user!!.uid !in blockedList) receiverChattingRef.child(myChat.uniqueQuerableTime).setValue(myChat)
