...
import com.azur.howfar.emoji.EmojiBottomsheetFragment
...
class HostLiveActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var lovesList = setOf<MomentDetails>()
    ...
    private fun setupLocalVideo() = runOnUiThread {
        ...
        agoraEngine!!.setupLocalVideo(VideoCanvas(localSurfaceView, VideoCanvas.RENDER_MODE_FIT, 1))
    }
    ...
    fun onclickGiftIcon(view: View?) {
        EmojiBottomsheetFragment().show(supportFragmentManager, "emojifragfmetn")
    }
